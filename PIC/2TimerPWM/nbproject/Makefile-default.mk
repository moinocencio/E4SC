...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/2TimerPWM.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/2TimerPWM.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/2TimerPWM.o: 2TimerPWM.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/2TimerPWM.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -DPK3OBPlatformTool=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/2TimerPWM.o.d" -o ${OBJECTDIR}/2TimerPWM.o 2TimerPWM.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/2TimerPWM.o: 2TimerPWM.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/2TimerPWM.o.d 
	@${RM} ${OBJECTDIR}/2TimerPWM.o 
	@${FIXDEPS} "${OBJECTDIR}/2TimerPWM.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/2TimerPWM.o.d" -o ${OBJECTDIR}/2TimerPWM.o 2TimerPWM.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
...
dist/${CND_CONF}/${IMAGE_TYPE}/2TimerPWM.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC_DIR}/xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/2TimerPWM.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
